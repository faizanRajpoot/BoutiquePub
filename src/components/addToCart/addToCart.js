    ...
    <div className="w-full ">
      ...
      <div className="w-full px-20 py-16 lg:px-10">
        ...
        <div className="w-full   flex justify-between mt-10 sm:flex sm:flex-col  ">
          ...
          <button onClick={proceed} className="w-72 h-16 sm:h-12 border-2 border-black uppercase text-xs font-semibold tracking-wider  sm:w-full sm:mt-5">Proceed To Checkout</button>
        </div>
      </div>
    </div>
  );
